...
import Personalinfo from '../Ccomponent/Personalinfo'
import Resumepreview from '../Ccomponent/Resumepreview'
import TemplateSelector from '../Ccomponent/TemplateSelector'
import Colorpicker from '../Ccomponent/Colorpicker'
import ProfessionalSummaryForm from '../Ccomponent/ProfessionalSummaryForm'
import ExperienceForm from '../Ccomponent/ExperienceForm'
import EducationForm from '../Ccomponent/EducationForm'
import ProjectForm from '../Ccomponent/ProjectForm'
import SkillsForm from '../Ccomponent/SkillsForm'
      ...
      <div className='grid lg:grid-cols-12 gap-8'>
        ...
        <div className= 'relative lg:col-span-5 rounded-lg overflow-hidden'>
          <div className='bg-white rounded-lg shadow-sm border border-gray-200
              p-6 pt-1'>
            {/* {Progressbar using ActirsectionIndex} */}
...
<button onClick={() => setActiveSectionIndex((prevIndex)=> Math.max(prevIndex -1 , 0))} className='flex items-center gap-1 p-3 rounded-text-sm font-medium text-gray-600 hover:bg-gray-50
...
<button onClick={() => setActiveSectionIndex((prevIndex)=> Math.min(prevIndex +1 , sections.length-1))} className={`flex items-center gap-1 p-3 rounded-lg text-sm font-medium text-gray-600 hover:bg-gray-50
   transition-all $ {activSectionIndex === sections.length -1 }`} disabled={activeSectionIndex === sections.length - 1}>
...
transition-all rounded-md px-6 py-2 mt-6 text-sm'>Save Changes</button>
        ...
        <div className='lg:col-span-7 max-lg:mt-6'>
          <div className='relative w-full'>
            <div className='absolute bottom-3 left-3 right-0 flex items-center justify-end gap-2'>
              {resumeData.public && (
