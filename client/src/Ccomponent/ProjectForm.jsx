...
const ProjectForm = ({ data, onChange }) => {
  ...
  return (
     <div className='space-y-6'>
        ...
        <button onClick={addProject} className='flex items-center gap-2 px-3 py-1 text-sm bg-green-100 text-green-700 
                    ...
                    { data.map((project,index) =>(
                        <div key={index} className='p-4 border border-gray-200 rounded-lg space-y-3'>
                            ...
                            <div className='grid  gap-3'>
                                ...
                                type="text" placeholder='project name' className='px-3 py-2 tesxt-sm  rounded-lg' />

                                <input value={project.type || ""} onChange={(e)=> updateProject(index,"type" , e.target.value)}
                                type="text" placeholder='project type' className='px-3 py-2 tesxt-sm  rounded-lg' />
