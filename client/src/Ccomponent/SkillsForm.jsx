  ...
  return (
    <div className='space-y-4'>
        ...
        className='flex-1 px-3 py-2 text-sm'
            ...
            value={newSkill}
            onKeyDown={handleKewyPress}/>
            <button onClick={addSkill} disabled={!newSkill.trim()} className='flex items-center gap-2 px-4 py-2 text-sm bg-blue-600 text-white rounded-1g hover:bg-blue-700 transition-colors disabled:opacity-50
         ...
         (
           ...
           <p className="text-sm">Add your technical and soft skills above.</p>
            ...
            <p className='text-sm text-blue-800'><strong>Tip:</strong> Add 8-12relevant skills. Include both technical skills (programming languages, tools) and soft skills (leadership, communication).</p>
     </div>
