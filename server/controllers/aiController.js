...
//controll for enhancing a resume's professional summary
//poet: /api/ai/enhance-pro-sum
...
export const uploadResume = async (req,res) =>{
    ...
    response_format: {type: 'json_object'}
        ...
        const paresedData = JSON.parse(extractedData)
        const newResume = await Resume.create({userId,title, ...paresedData})
